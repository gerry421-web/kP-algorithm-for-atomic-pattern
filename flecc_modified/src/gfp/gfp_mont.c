...
#include <flecc_modified/include/flecc_in_c/bi/bi.h>
#include <flecc_modified/include/flecc_in_c/gfp/gfp_gen.h>
#include <flecc_modified/include/flecc_in_c/gfp/gfp_mont.h>
...
void gfp_mult_two_mont( gfp_t res, const gfp_t a, const gfp_t b, const gfp_prime_data_t *prime_data, gfp_t r_squared ) {
    ...
    //gfp_mont_multiply( res, res, r_squared, prime_data );  /* Modification to meet the purposes of this project */
    //gfp_mont_multiply( res, res, prime_data->r_squared, prime_data );
    gfp_cr_mont_multiply_sos( res, a, b, prime_data );
    gfp_cr_mont_multiply_sos( res, res, r_squared, prime_data ); /* Modification to meet the purposes of this project */
}
